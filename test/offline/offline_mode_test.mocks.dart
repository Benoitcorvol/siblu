...
// in camping_game_show/test/offline/offline_mode_test.dart.
...
import 'package:camping_game_show/core/services/connectivity_service.dart'
    as _i2;
import 'package:camping_game_show/core/services/sync_service.dart' as _i4;
...
class MockSyncService extends _i1.Mock implements _i4.SyncService {
  ...
  @override
  _i3.Future<void> performInitialSync() =>
      (super.noSuchMethod(
            Invocation.method(#performInitialSync, []),
  ...
  @override
  void startSyncListener() => super.noSuchMethod(
    Invocation.method(#startSyncListener, []),
    returnValueForMissingStub: null,
  );
}
